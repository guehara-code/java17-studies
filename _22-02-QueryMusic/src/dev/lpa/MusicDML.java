...
//        return insertResult;
    ...
    private static boolean updateRecord(Statement statement, String table,
        ...
        String query = "UPDATE %s SET %s = '%s' WHERE %s= '%s'"
                .formatted(table, updatedColumn, updatedValue,
...
//            System.out.printf("Deleted %d rows form music.albums%n", deletedAlbums);
...
//            System.out.printf("Deleted %d rows form music.artists%n", deletedArtists);
